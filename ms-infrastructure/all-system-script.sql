...
(
    id serial  not null constraint product_category_pk primary key,
    category_id integer not null constraint product_category_category_id_fk references category,
...
(
    id serial not null constraint stock_status_pk primary key,
...
(
    id serial not null constraint ms_product_pk primary key,
    name varchar(255),
    price double precision,
    inventory_status_id integer constraint ms_product_stock_status_id_fk references stock_status,
